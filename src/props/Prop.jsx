        ...
        <div>
            ...
            <div id="menu2">
                <ul>
                    ...
                    <li><img src={props.menu18} /><a href="#"></a></li>
                </ul>
                ...
                <div id="model">
                    ...
                    <div id="modelnya">
                        <div id="pertama">
                            ...
                            <h5>ALL UNDER RP188.000</h5>
                            <p><ReadMoreReact className="readmore" text={props.modela} min={10} ideal={20} max={25}
                                readMoreText="Read More...."></ReadMoreReact> </p>
                        </div>
                        <div id="kedua">
                            <img src={props.model2} />
                            <h5>KEMEJA DI BAWAH RP249.000</h5>
                            <p><ReadMoreReact className="readmore" text={props.modelb} min={10} ideal={20} max={25}
                                readMoreText="Read More...."></ReadMoreReact></p>
                        </div>
                        <div id="ketiga">
                            <img src={props.model3} />
                            <h5>THE CROSSBODY BAGS UP TO 70% OFF</h5>
                            <p><ReadMoreReact className="readmore" text={props.modelc} min={10} ideal={20} max={25}
                                readMoreText="Read More...."></ReadMoreReact></p>
                        </div>
                    </div>
                </div>
            ...
            <div id="footer">
                CopyRight &copy; Babastudio 2019
            </div>
        </div>
    );
}
